            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="reference_number" class="col-sm-3 control-label">ID Karyawan</label>
                    ...
                    <div class="form-group">
                        <label for="mname" class="col-sm-3 control-label">Nama Tengah</label>
                    ...
                    <div class="form-group">
                        <label for="phone" class="col-sm-3 control-label">Nomor HP</label>
                    ...
                    <div class="form-group">
                        <label for="residence_status" class="col-sm-3 control-label">Status Alamat</label>
                    ...
                    <div class="form-group">
                        <label for="residence" class="col-sm-3 control-label">Alamat</label>
                    ...
                    <div class="form-group">
                        <label for="programme" class="col-sm-3 control-label">Posisi</label>
                    ...
                    <div class="form-group">
                        <label for="admission_year" class="col-sm-3 control-label">Tahun</label>
